...
# Server FTP con certificato SSL
    def run(self,*args):
        ...
        handler.masquerade_address = 'XXX.XX.XX.XX' # Inserisci qui il tuo IP pubblico. Serve alla modalità PASV
...
if __name__ == "__main__":
    ...
    TCP = TCP("XXX.XX.XX.XX",52000,backlog=5) # Inserisci qui il tuo IP locale
    FTP = FTP("XXX.XX.XX.XX",2121,"Mattia Giambirtone","Password1971_","Benvenuto!") # Inserisci il tuo IP locale
